...
public static class RelicWeaponGuide
{
    ...
    public static readonly IReadOnlyList<PhantomWeaponJob> ElegantWeaponJobs = new[]
    {
        ...
        new PhantomWeaponJob("war", "战士", StageItems("改良型浴血被提", "浴血被提·优雅")),
        new PhantomWeaponJob("drg", "龙骑士", StageItems("改良型黑狼", "黑狼·优雅")),
        new PhantomWeaponJob("nin", "忍者", StageItems("改良型忍者菜刀", "忍者菜刀·优雅")),
        new PhantomWeaponJob("sam", "武士", StageItems("改良型弦月玉兔", "弦月玉兔·优雅")),
        new PhantomWeaponJob("rpr", "钐镰客", StageItems("改良型胜利属于人民", "胜利属于人民·优雅")),
        new PhantomWeaponJob("vpr", "蝰蛇剑士", StageItems("改良型邪焰冥灯", "邪焰冥灯·优雅")),
        new PhantomWeaponJob("drk", "暗黑骑士", StageItems("改良型青鸟之巢", "青鸟之巢·优雅")),
        new PhantomWeaponJob("gnb", "绝枪战士", StageItems("改良型百合中的相遇", "百合中的相遇·优雅")),
        new PhantomWeaponJob("whm", "白魔法师", StageItems("改良型仙女迷恋", "仙女迷恋·优雅")),
        new PhantomWeaponJob("sch", "学者", StageItems("改良型双月", "双月·优雅")),
        new PhantomWeaponJob("ast", "占星术士", StageItems("改良型彼岸此岸", "彼岸此岸·优雅")),
        new PhantomWeaponJob("sge", "贤者", StageItems("改良型灯火手杖", "灯火手杖·优雅")),
        new PhantomWeaponJob("brd", "吟游诗人", StageItems("改良型刻耳柏洛斯之牙", "刻耳柏洛斯之牙·优雅")),
        new PhantomWeaponJob("mch", "机工士", StageItems("改良型美丽的树枝", "美丽的树枝·优雅")),
        new PhantomWeaponJob("dnc", "舞者", StageItems("改良型观星者", "观星者·优雅")),
        new PhantomWeaponJob("blm", "黑魔法师", StageItems("改良型化身之镰", "化身之镰·优雅")),
        new PhantomWeaponJob("smn", "召唤师", StageItems("绅魔法师的伞", "绅魔法师的伞·优雅")),
        new PhantomWeaponJob("rdm", "赤魔法师", StageItems("改良型碎石怒环", "碎石怒环·优雅")),
        new PhantomWeaponJob("pct", "绘灵法师", StageItems("改良型索林之刃", "索林之刃·优雅")),
    };
